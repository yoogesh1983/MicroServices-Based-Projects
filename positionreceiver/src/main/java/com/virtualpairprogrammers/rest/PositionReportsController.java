...
public class PositionReportsController 
{
	...
	{
		/**************Start Simulationg for Hystrix Circuit Breaker ****************************/
	    //if(Math.random() < 0.75) throw new RuntimeException("Problems!! Given up");
		/****************Finish Simulating for Hystrix Circuit breaker *************************/
